...
// Definicje ekranow
static unsigned char code KlimaOFF[]= "KLIMATYZACJA    "
                                      "WYLACZONA       "
																			"                "
																			"                ";
																			
static unsigned char code KlimaON[]=  "KLIMATYZACJA    "
                                      "WLACZONA        "
																			"tryb            "
																			"moc nadmuchu    ";
																			
static unsigned char code TRC[]=  "KONTROLA TRAKCJI"
                                  "                "
																	"                "
																	"                ";
